    ...
    try {
      ...
      if (landmarks.length === 0) {
        ...
        for (const landmark of landmarks) {
          await storage.addLandmark(landmark);
        }
      }
...
async function fetchBuuLongRoads(): Promise<any[]> {
  ...
  // These coordinates are based on the Dong Nai University area as shown in the image
  
  const roads = [
    {
      name: "Đường Đồng Khởi (East-West)",
      coordinates: [
        [10.9573, 106.8550],
        [10.9570, 106.8570],
        [10.9568, 106.8590],
    ...
    {
      name: "Đường Quang Trung (East-West)",
      coordinates: [
        [10.9600, 106.8540],
        [10.9597, 106.8560],
        [10.9594, 106.8580],
